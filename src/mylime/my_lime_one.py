...
class LimeTabularExplainer(object):
    ...
    def __data_inverse(self,
        ...
        if self.discretizer is None:
            ...
            data = self.random_state.randint(0,1,num_samples * num_cols).reshape(num_samples, num_cols)
            print("data = self.random_state.normal(0, 1, num_samples * num_cols).reshape(num_samples, num_cols)",data)
            print("data len ",len(data[0]))
            if self.sample_around_instance:
                print("self.sample_around_instance",self.sample_around_instance)
        ...
        inverse[0] = data_row
        with open('/root/ml-at-work/chap07/pickle/one_diff_data', 'rb') as f:
